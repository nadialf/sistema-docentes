      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right" style="margin:10px;">
                  <li>
                    <a href="<?php echo base_url().'actividades/act_doc/'.$row->ID_Trabajador; ?>">
                      <div style="color:#FFF;">
                  ...
                  <li>
                     <a href="<?php echo base_url().'correo/correo_doc/'.$row->ID_Trabajador?>">
                      <div style="color:#FFF;">
                  ...
                  <li>
                     <a href="<?php echo base_url().'constancias/cons_docente/'.$row->ID_Trabajador?>">
                      <div style="color:#FFF;">
